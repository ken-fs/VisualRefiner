...
export const guides: GuideMeta[] = [
  ...
  {
    slug: "/guides/remove-gps-location-from-photos",
    title: "How to remove GPS location from your photos",
    description: "Photos can carry the exact spot where they were taken. How to check for GPS metadata and strip it before a buyer, follower, or stranger sees it.",
    hook: "A photo from your porch tells people where your porch is.",
    datePublished: "2026-09-03",
  },
  {
    slug: "/guides/what-is-exif-data",
    title: "What is EXIF data? The hidden label inside your photos",
    description: "EXIF is the note your camera writes into every photo — time, device, settings, sometimes location. What it is, why it exists, and when to remove it.",
    hook: "Your camera has been keeping notes.",
    datePublished: "2026-09-03",
  },
  {
    slug: "/guides/how-to-tell-if-an-image-is-ai-generated",
    title: "How to tell if an image is AI-generated",
    description: "Visual tells are fading. How to check an image properly: what to look for, what C2PA credentials can prove, and what no test can settle.",
    hook: "Your eyes used to be enough.",
    datePublished: "2026-09-03",
  },
  {
...
const toolGuideMap: Record<string, string[]> = {
  ...
  "/remove-metadata": ["/guides/remove-image-metadata", "/guides/remove-metadata-iphone-photos", "/guides/remove-gps-location-from-photos"],
  "/remove-video-metadata": ["/guides/video-metadata"],
  "/check-image-origin": ["/guides/what-is-c2pa", "/guides/how-to-tell-if-an-image-is-ai-generated", "/guides/remove-image-metadata"],
